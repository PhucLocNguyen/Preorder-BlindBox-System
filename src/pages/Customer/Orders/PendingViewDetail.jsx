...
import { GetAllOrderTempDetailsByTempOrderID } from "../../../api/OrderDetail/ApiOrderDetail";
import { GetTempOrderById } from "../../../api/Order/ApiOrder";
...
function ViewDetail() {
  ...
  const getDetailOrder = async () => {
    var responseOrderDetails = await GetAllOrderTempDetailsByTempOrderID(id);
    var responseOrderInformation = await GetTempOrderById(id);
