...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		...
		{
			entity.HasKey(e => e.BannerId).HasName("PK__Banners__32E86A3167D565B5");
		...
		{
			entity.HasKey(e => e.BlindBoxId).HasName("PK__BlindBox__4FDFECB20B47CB57");
		...
		{
			entity.HasKey(e => e.CartId).HasName("PK__Carts__51BCD7973AF23FDE");
		...
		{
			entity.HasKey(e => e.ImageId).HasName("PK__Images__7516F4EC60D11E1E");
		...
		{
			entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E32FCDB4121");
		...
		{
			entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAFB9F67AB3");
		...
		{
			entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D30C6FC8CB21");
		...
		{
			entity.HasKey(e => e.PreorderCampaignId).HasName("PK__Preorder__4FE60AAEF7B4100A");

			entity.HasIndex(e => e.Slug, "UQ__Preorder__BC7B5FB6C4001F26").IsUnique();
		...
		{
			entity.HasKey(e => e.PreorderMilestoneId).HasName("PK__Preorder__EF1156A9893079AE");
		...
		{
			entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE3AFADCF94A");
		...
		{
			entity.HasKey(e => e.TransactionId).HasName("PK__Transact__55433A4BB1FD636B");
		...
		{
			entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCACAD4317DB");
		...
		{
			entity.HasKey(e => e.UserVoucherId).HasName("PK__UserVouc__8017D4B9F8790817");
		...
		{
			entity.HasKey(e => e.VoucherCampaignId).HasName("PK__VoucherC__0E161B2F6133F43C");
		...
		{
			entity.HasKey(e => e.WalletId).HasName("PK__Wallets__84D4F92E48817EAD");
