...
+ "                                          </p>\n"
				...
				+ "                            <a href=\"https://test-fe-cookie.vercel.app/confirmemail?token=" + tokenConfirm + "\"\n"
		...
		public static string ForgotPasswordEmail(string userName, string forgotPasswordToken, string email)
		{
			return "<div style=\"max-width: 650px; margin: 0px auto;\">\r\n" +
                ...
                "                                 <a href=\"https://test-fe-cookie.vercel.app/user-forget-password?email=" + email + "&token=" + forgotPasswordToken + "\">Xác nhận thay đổi mật khẩu</a>\r\n" +
				"                              </div>\r\n" +
				"                              <div\r\n" +
